...
DEF_VOID_FUNC_1(SampleSubFunc_004_001, BYTE**, input1);
END_DEF_TD(SampleSubFunc_004_001)

BEGIN_DEF_TD(SampleSubFunc_004_002)
DEF_VOID_FUNC(SampleSubFunc_004_002)
END_DEF_TD(SampleSubFunc_004_002)

BEGIN_DEF_TD(SampleSubFunc_004_003)
REG_VALUE_ARG(SampleSubFunc_004_003, int, input1)
DEF_VOID_FUNC(SampleSubFunc_004_003, int, input1)
END_DEF_TD(SampleSubFunc_004_003)

BEGIN_DEF_TD(SampleSubFunc_004_004)
