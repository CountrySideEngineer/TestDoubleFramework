...
#define SET_ARG_VAL(FUNC_NAME, ARG_NAME, CALL_INDEX, ARG_VAL)	\
	ARG_VAL(FUNC_NAME, ARG_NAME, CALL_INDEX) = ARG_VAL;
...
#define PTR_ARG_RET_VAL_SIZE(FUNC_NAME, ARG_NAME, CALL_INDEX, VAL_INDEX)	\
	FUNC_NAME##_##ARG_NAME##_return_value_size[CALL_INDEX]

#define SET_PTR_ARG_RET_VAL_SIZE(FUNC_NAME, ARG_NAME, CALL_INDEX, VAL_INDEX, VAL_SIZE)	\
	PTR_ARG_RET_VAL_SIZE(FUNC_NAME, ARG_NAME, CALL_INDEX, VAL_INDEX) = VAL_SIZE;
